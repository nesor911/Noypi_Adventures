var Gamestats2= function(game){
  Phaser.Group.call(this, game);
};

Gamestats2.prototype = Object.create(Phaser.Group.prototype);
Gamestats2.prototype.constructor = Gamestats2;

Gamestats2.prototype.show = function(score){
  ...
  gameoverText = this.game.add.bitmapText(0, this.game.height / 3, 'minecraftia', 'Onto the next level!', 36);
...
Gamestats2.prototype.onClick = function(){
  this.game.state.start('Intro3');
};
